					...
					<View style={styles.order_item_right_bottom}>
						...
						{type === 1 ? (
							<TouchableOpacity onPress={this.payOrder.bind(this)} style={styles.order_item_right_bottom_btn}>
								<Text style={styles.order_pay_font}>扫码取件</Text>
							</TouchableOpacity>
						) : null}
						{/* 待派送 */}
						{type === 2 ? (
							<TouchableOpacity onPress={this.onSetMoney.bind(this)} style={styles.order_item_right_bottom_btn}>
								<Text style={styles.order_pay_font}>设置金额</Text>
							</TouchableOpacity>
						) : null}
						{type === 2 ? (
							<TouchableOpacity onPress={this.payOrder.bind(this)} style={styles.order_item_right_bottom_btn}>
								<Text style={styles.order_pay_font}>扫码开门</Text>
							</TouchableOpacity>
						) : null}

						<TouchableOpacity onPress={this.onConcatUser.bind(this)} style={styles.order_item_right_bottom_btn}>
